package com.xiaoyuan.web.user.dto;
...
public void setAuthImgs(String authImgs) {
...
public String getUserOrgIntro() {
	return userOrgIntro;
}
public void setUserOrgIntro(String userOrgIntro) {
	this.userOrgIntro = userOrgIntro;
}
