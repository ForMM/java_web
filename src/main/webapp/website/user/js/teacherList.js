...
//				console.log(JSON.stringify(e));	
				...
				for(var i=0;i<orgUsers.length;i++){
					...
					$("#org-teacher-list").append(orgTeacherObj.createHtml(orgUser.headImg,orgUser.userName,orgUser.userPhone,orgUser.schoolName,orgUser.userOrgIntro,orgUser.userOrgId));
				}
...
//				console.log(JSON.stringify(e));	
				location.href=getBasePath()+"/user/teacherListPage.do";
			});	
		}
}
