...
<script type="text/javascript" src="<%=basePath%>website/common/js/ajaxfileupload.js"></script>
 <script type="text/javascript" src="<%=basePath%>website/article/js/addArticle.js"></script> 
...
<input id="basePath" type="hidden" value="<%=basePath%>">
	<div class="article-div">
		<div>
			...
			<div>
				<input type="text" id="article-title" class="form-control" placeholder="标题">				
			</div>
		</div>
		<div class="article-content-div">
			<div class="type-name">文章内容</div>
			<div class="article-content">							
				<textarea class="layui-textarea" id="article-content" style="display: none"></textarea>
			</div>
		</div>
