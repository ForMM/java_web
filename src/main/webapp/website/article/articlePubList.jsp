...
<script type="text/javascript" src="<%=basePath%>website/article/js/articlePubList.js"></script>
					...
					<div class="article-unit">
						 ...
						 <div class="intro" articleId="{{= articleId}}">
						 		...
						 		<div class="tag">
									...
									<span class="article-comment"><a class="comment-info">评论({{= article.comments}})</a><a class="article-top" articleId="{{= articleId}}">置顶</a></span>								
						 		</div>
